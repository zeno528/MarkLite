...
2. **Chromium 149 IME bug（运行时，非构建问题）**：用户 WebView2 ≥ 149.0.7827.103 时，中文拼音首次输入可能要按两次空格。上游 Chromium bug，应用层无可靠绕过，等上游修。详见项目 `CLAUDE.md`「已知问题」。构建不受影响。
