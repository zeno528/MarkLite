    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-3">
        <button
          ...
          className="inline-flex cursor-pointer items-center gap-1.5 rounded-md bg-[var(--color-bg-muted)] px-3 py-1.5 text-xs text-[var(--color-text)] transition-colors hover:bg-[var(--color-bg-subtle)]"
        >
